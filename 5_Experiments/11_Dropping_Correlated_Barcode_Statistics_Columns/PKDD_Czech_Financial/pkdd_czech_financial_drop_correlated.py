...
# GET DATASET
# =============================================================================
TDA_DIR = ROOT / "1_Data" / "TDA_Datasets" / "PKDD_Czech_Financial" / "3_PH_Default_Parameters"
if not (TDA_DIR / "data_L10.csv").exists() or not (TDA_DIR / "data_L20.csv").exists():
    raise SystemExit(
        f"Missing Experiment 3 matrices under {TDA_DIR}. "
        "Run 5_Experiments/3_PH_Default_Parameters/PKDD_Czech_Financial/ first."
    )
...
# =============================================================================
save_path_var = str(ROOT / "1_Data/TDA_Datasets/PKDD_Czech_Financial/11_Dropping_Correlated_Barcode_Statistics_Columns/Using_High_Variance_For_Correlation")
save_path_target = str(ROOT / "1_Data/TDA_Datasets/PKDD_Czech_Financial/11_Dropping_Correlated_Barcode_Statistics_Columns/Using_Target_Variable_For_Correlation")
save_path_results = str(ROOT / "6_Results/11_Dropping_Correlated_Barcode_Statistics_Columns/PKDD_Czech_Financial")
