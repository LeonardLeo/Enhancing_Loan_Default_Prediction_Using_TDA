...
compute_barcodes_from_multiple_landmarks(
    landmark_percentages=percentages,
    landmark_dir="../../../1_Data/Landmark_Sets/South_German_Credit/4_PH_Tuned_Parameters",
    barcode_output_dir="../../../1_Data/Barcode_Statistics/South_German_Credit/4_PH_Tuned_Parameters",
    dim=2,
...
build_final_barcode_statistics_data(
    landmark_percentages=percentages,
    barcode_dir="../../../1_Data/Barcode_Statistics/South_German_Credit/4_PH_Tuned_Parameters",
    output_dir="../../../1_Data/TDA_Datasets/South_German_Credit/4_PH_Tuned_Parameters",
    label={1: "default", 0: "non-default"},
)
...
# =============================================================================
paths = [
    "../../../1_Data/TDA_Datasets/South_German_Credit/4_PH_Tuned_Parameters/data_L10.csv",
    "../../../1_Data/TDA_Datasets/South_German_Credit/4_PH_Tuned_Parameters/data_L20.csv",
]
...
# STORE MODEL RESULTS
# =============================================================================
save_path = "../../../6_Results/4_PH_Tuned_Parameters/South_German_Credit"
