...
from utils import (train_multiple_dataset_tda_linear_regression,
...
generate_landmark_sets(class_label_and_data = {"default": default_data.copy().drop("Class", 
                       ...
                       dataset_to_use = "Default",
                       n_files_per_percentage = 500,
                       experiment_name = "19_Linear_Regression_For_Prediction")
...
compute_barcodes_from_multiple_landmarks(landmark_percentages = percentages, # Should be same as used in GENERATE LANDMARK SETS function
                                         landmark_dir = "../../../1_Data/Landmark_Sets/Default_Of_Credit_Card_Client_Data/19_Linear_Regression_For_Prediction", 
                                         barcode_output_dir = "../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/19_Linear_Regression_For_Prediction", 
                                         dim = 2, 
                                         label = {1: "default",
                                                  0: "non-default"})
...
build_final_barcode_statistics_data(landmark_percentages = percentages,
                                    barcode_dir = "../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/19_Linear_Regression_For_Prediction",
                                    output_dir = "../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/19_Linear_Regression_For_Prediction",
                                    label = {1: "default",
                                             0: "non-default"})
...
# =============================================================================
paths = ["../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/19_Linear_Regression_For_Prediction/data_L5.csv", 
         "../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/19_Linear_Regression_For_Prediction/data_L15.csv",]

model_results = train_multiple_dataset_tda_linear_regression(path_datasets = paths,
                                                             y_col_name = "label",
                                                             test_size = 0.2,
                                                             random_state = 42)
...
# STORE MODEL RESULTS
# =============================================================================
save_path = "../../../6_Results/19_Linear_Regression_For_Prediction/Default_Of_Credit_Card_Client_Data"
