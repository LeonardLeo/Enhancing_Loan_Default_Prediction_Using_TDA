# Taiwan_Bankruptcy — Early_Split_TDA / 7_Snapshot_Mean_Variance
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/7_Snapshot_Mean_Variance/Taiwan_Bankruptcy/run.py
```
