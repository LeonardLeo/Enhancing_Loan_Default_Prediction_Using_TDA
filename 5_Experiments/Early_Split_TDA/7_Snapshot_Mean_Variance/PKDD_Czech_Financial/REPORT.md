# PKDD_Czech_Financial — Early_Split_TDA / 7_Snapshot_Mean_Variance
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/7_Snapshot_Mean_Variance/PKDD_Czech_Financial/run.py
```
