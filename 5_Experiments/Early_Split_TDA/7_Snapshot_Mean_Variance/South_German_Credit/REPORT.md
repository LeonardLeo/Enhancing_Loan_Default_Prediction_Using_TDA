# South_German_Credit — Early_Split_TDA / 7_Snapshot_Mean_Variance
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/7_Snapshot_Mean_Variance/South_German_Credit/run.py
```
