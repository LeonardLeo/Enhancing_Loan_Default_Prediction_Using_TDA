# Taiwan_Bankruptcy — Early_Split_TDA / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/6_Sampling_Ratio_Audit/Taiwan_Bankruptcy/run.py
```
