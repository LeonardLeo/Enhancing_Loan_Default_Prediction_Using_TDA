# PKDD_Czech_Financial — Early_Split_TDA / 1_PH_Default_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/1_PH_Default_Parameters/PKDD_Czech_Financial/run.py
```
