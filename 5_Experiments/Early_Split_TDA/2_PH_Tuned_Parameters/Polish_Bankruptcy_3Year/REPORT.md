# Polish_Bankruptcy_3Year — Early_Split_TDA / 2_PH_Tuned_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/2_PH_Tuned_Parameters/Polish_Bankruptcy_3Year/run.py
```
