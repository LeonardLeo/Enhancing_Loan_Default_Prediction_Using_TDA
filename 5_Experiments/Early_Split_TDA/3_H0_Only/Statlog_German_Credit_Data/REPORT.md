# Statlog_German_Credit_Data — Early_Split_TDA / 3_H0_Only
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/3_H0_Only/Statlog_German_Credit_Data/run.py
```
