# Taiwan_Bankruptcy — Early_Split_TDA / 5_Linear_Regression_For_Prediction
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/5_Linear_Regression_For_Prediction/Taiwan_Bankruptcy/run.py
```
