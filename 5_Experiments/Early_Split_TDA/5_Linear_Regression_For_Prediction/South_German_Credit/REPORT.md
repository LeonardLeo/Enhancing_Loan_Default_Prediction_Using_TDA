# South_German_Credit — Early_Split_TDA / 5_Linear_Regression_For_Prediction
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/5_Linear_Regression_For_Prediction/South_German_Credit/run.py
```
