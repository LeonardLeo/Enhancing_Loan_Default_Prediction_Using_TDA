# Polish_Bankruptcy_3Year — Early_Split_TDA / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/8_Null_Hypothesis_Algorithm2/Polish_Bankruptcy_3Year/run.py
```
