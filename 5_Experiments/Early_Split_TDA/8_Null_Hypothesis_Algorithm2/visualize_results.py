# -*- coding: utf-8 -*-
"""Visualize artefacts for Early_Split_TDA / 8_Null_Hypothesis_Algorithm2.

Runnable from this experiment directory:

    python visualize_results.py

Run this script; figures land in `6_Results/Early_Split_TDA/8_Null_Hypothesis_Algorithm2/Visualizations/`.
