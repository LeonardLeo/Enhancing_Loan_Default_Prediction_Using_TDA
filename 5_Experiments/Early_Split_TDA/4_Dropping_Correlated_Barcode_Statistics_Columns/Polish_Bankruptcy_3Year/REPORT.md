# Polish_Bankruptcy_3Year — Early_Split_TDA / 4_Dropping_Correlated_Barcode_Statistics_Columns
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/4_Dropping_Correlated_Barcode_Statistics_Columns/Polish_Bankruptcy_3Year/run.py
```
