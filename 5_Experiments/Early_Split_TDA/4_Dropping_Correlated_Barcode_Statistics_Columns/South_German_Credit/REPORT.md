# South_German_Credit — Early_Split_TDA / 4_Dropping_Correlated_Barcode_Statistics_Columns
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/4_Dropping_Correlated_Barcode_Statistics_Columns/South_German_Credit/run.py
```
