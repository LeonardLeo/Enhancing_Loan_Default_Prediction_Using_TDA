# Taiwan_Bankruptcy — Early_Split_TDA / 4_Dropping_Correlated_Barcode_Statistics_Columns
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA/4_Dropping_Correlated_Barcode_Statistics_Columns/Taiwan_Bankruptcy/run.py
```
