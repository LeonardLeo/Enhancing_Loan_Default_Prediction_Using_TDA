# -*- coding: utf-8 -*-
"""Run 4_Dropping_Correlated_Barcode_Statistics_Columns for every dataset in Early_Split_TDA."""
...
def main() -> int:
    ...
    for folder in DATASETS:
        ...
        if script is None:
            ...
            continue
        print("=" * 72)
        print(f"Early_Split_TDA / 4_Dropping_Correlated_Barcode_Statistics_Columns — {folder}")
        print(script)
        print("=" * 72)
