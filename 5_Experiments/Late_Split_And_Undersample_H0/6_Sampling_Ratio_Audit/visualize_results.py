# -*- coding: utf-8 -*-
"""Visualize artefacts for Late_Split_And_Undersample_H0 / 6_Sampling_Ratio_Audit.

Runnable from this experiment directory:

    python visualize_results.py

Run this script; figures land in `6_Results/Late_Split_And_Undersample_H0/6_Sampling_Ratio_Audit/Visualizations/`.
