# Late_Split_And_Undersample_H0 — 1_PH_Default_Parameters
...
6_Results/Late_Split_And_Undersample_H0/1_PH_Default_Parameters/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_And_Undersample_H0/1_PH_Default_Parameters/<Dataset>/<script>.py
```
