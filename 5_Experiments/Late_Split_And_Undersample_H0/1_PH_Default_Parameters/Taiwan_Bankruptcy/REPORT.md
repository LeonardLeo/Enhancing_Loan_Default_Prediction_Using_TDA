# Taiwan_Bankruptcy — Late_Split_And_Undersample_H0 / 1_PH_Default_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_And_Undersample_H0/1_PH_Default_Parameters/Taiwan_Bankruptcy/run.py
```
