# Default_Of_Credit_Card_Client_Data — Late_Split_And_Undersample_H0 / 1_PH_Default_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_And_Undersample_H0/1_PH_Default_Parameters/Default_Of_Credit_Card_Client_Data/run.py
```
