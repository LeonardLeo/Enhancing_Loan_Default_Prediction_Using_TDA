# Late_Split_And_Undersample_H0 — 8_Null_Hypothesis_Algorithm2
...
6_Results/Late_Split_And_Undersample_H0/8_Null_Hypothesis_Algorithm2/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_And_Undersample_H0/8_Null_Hypothesis_Algorithm2/<Dataset>/<script>.py
```
