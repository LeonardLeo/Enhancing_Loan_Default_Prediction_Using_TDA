# PKDD_Czech_Financial — Late_Split_And_Undersample_H0 / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_And_Undersample_H0/8_Null_Hypothesis_Algorithm2/PKDD_Czech_Financial/run.py
```
