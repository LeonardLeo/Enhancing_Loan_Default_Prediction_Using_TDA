...
results = run_experiments_with_pca_components(data_path = r"../../../1_Data/Processed_Datasets/Default_Of_Credit_Card_Client_Data/processed_data.xlsx",
                                              ...
                                              results_save_path = "../../../6_Results/16_Variance_Retained_for_Default_of_Credit_Card_Client_Dataset/Default_Of_Credit_Card_Client_Data",
...
# Store Results
# =============================================================================
save_path = "../../../6_Results/16_Variance_Retained_for_Default_of_Credit_Card_Client_Dataset/Default_Of_Credit_Card_Client_Data"
...
plot_results_knn = plot_all_metrics_vs_pca_components(all_results = results,
                                                      model_key = "knn",
                                                      save_path = "../../../6_Results/16_Variance_Retained_for_Default_of_Credit_Card_Client_Dataset/Default_Of_Credit_Card_Client_Data/viz",
                                                      separate_plots = True)
