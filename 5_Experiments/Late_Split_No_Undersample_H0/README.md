# Late split, no undersample, using just H0

Folder: `Late_Split_No_Undersample_H0`

Public name (figures and paper tables): **Late split, no undersample, using just H0**. Names come from `utils.process_display_name()`.

This process **slices** homology-0 columns from the sibling `Late_Split_No_Undersample_H0_And_H1` barcode tables. It does not run Ripser.
