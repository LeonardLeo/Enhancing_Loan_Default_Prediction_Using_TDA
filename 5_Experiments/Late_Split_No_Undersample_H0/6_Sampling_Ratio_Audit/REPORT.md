# Late_Split_No_Undersample_H0 — 6_Sampling_Ratio_Audit
...
6_Results/Late_Split_No_Undersample_H0/6_Sampling_Ratio_Audit/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_No_Undersample_H0/6_Sampling_Ratio_Audit/<Dataset>/<script>.py
```
