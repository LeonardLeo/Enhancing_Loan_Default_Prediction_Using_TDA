# Statlog_German_Credit_Data — Late_Split_No_Undersample_H0 / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_No_Undersample_H0/6_Sampling_Ratio_Audit/Statlog_German_Credit_Data/run.py
```
