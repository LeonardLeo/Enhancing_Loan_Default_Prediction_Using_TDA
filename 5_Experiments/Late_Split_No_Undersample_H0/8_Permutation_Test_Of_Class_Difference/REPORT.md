# Late_Split_No_Undersample_H0 — 8_Permutation_Test_Of_Class_Difference
...
```
1_Data/Landmark_Sets/Late_Split_No_Undersample_H0_And_H1/1_PH_Default_Parameters/{Dataset}/  (sibling H0-and-H1 Ripser run)
1_Data/Barcode_Statistics/Late_Split_No_Undersample_H0_And_H1/1_PH_Default_Parameters/{Dataset}/  (sibling H0-and-H1 Ripser run)
1_Data/TDA_Datasets/Late_Split_No_Undersample_H0/1_PH_Default_Parameters/{Dataset}/data_L*.csv
6_Results/Late_Split_No_Undersample_H0/8_Permutation_Test_Of_Class_Difference/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_No_Undersample_H0/8_Permutation_Test_Of_Class_Difference/<Dataset>/<script>.py
```
