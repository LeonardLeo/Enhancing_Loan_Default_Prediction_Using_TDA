# -*- coding: utf-8 -*-
"""
Late split and undersample (the original historical run), using both H0 and H1 / 1_PH_Default_Parameters
...
# =============================================================================
# Balance classes (undersample majority to the minority count)
# =============================================================================
...
default_data = default_data.sample(n=n_samples, random_state=42).reset_index(drop=True)
non_default_data = non_default_data.sample(n=n_samples, random_state=42).reset_index(drop=True)
...
# =============================================================================
paths = [
    os.path.join(tda_dir, "data_L30.csv"),
    os.path.join(tda_dir, "data_L60.csv"),
]
