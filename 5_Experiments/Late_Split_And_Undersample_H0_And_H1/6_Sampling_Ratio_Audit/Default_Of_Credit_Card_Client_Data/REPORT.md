# Default_Of_Credit_Card_Client_Data — Late_Split_And_Undersample_H0_And_H1 / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_And_Undersample_H0_And_H1/6_Sampling_Ratio_Audit/Default_Of_Credit_Card_Client_Data/run.py
```
