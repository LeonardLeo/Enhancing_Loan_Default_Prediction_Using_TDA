...
```
.\tda_env\Scripts\python.exe 5_Experiments/Archives/Four_Arm_Nested_Experiments/No_Undersampling/4_Dropping_Correlated_Barcode_Statistics_Columns/<Dataset>/<script>.py
```
