# PKDD_Czech_Financial — Early_Split_TDA_And_No_Undersampling / 3_H0_Only
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/3_H0_Only/PKDD_Czech_Financial/run.py
```
