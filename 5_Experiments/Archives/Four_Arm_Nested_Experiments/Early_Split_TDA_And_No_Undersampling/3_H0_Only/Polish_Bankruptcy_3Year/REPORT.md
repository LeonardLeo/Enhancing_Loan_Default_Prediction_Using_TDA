# Polish_Bankruptcy_3Year — Early_Split_TDA_And_No_Undersampling / 3_H0_Only
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/3_H0_Only/Polish_Bankruptcy_3Year/run.py
```
