...
```
.\tda_env\Scripts\python.exe 5_Experiments/Archives/Four_Arm_Nested_Experiments/Early_Split_TDA_And_No_Undersampling/3_H0_Only/Default_Of_Credit_Card_Client_Data/run.py
```
