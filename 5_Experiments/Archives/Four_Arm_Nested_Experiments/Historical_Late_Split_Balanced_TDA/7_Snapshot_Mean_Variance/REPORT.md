...
6_Results/Historical_Late_Split_Balanced_TDA/7_Snapshot_Mean_Variance/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Archives/Four_Arm_Nested_Experiments/Historical_Late_Split_Balanced_TDA/7_Snapshot_Mean_Variance/<Dataset>/<script>.py
```
