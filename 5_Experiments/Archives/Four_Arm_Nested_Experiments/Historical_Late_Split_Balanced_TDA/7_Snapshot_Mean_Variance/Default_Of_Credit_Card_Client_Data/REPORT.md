...
```
.\tda_env\Scripts\python.exe 5_Experiments/Archives/Four_Arm_Nested_Experiments/Historical_Late_Split_Balanced_TDA/7_Snapshot_Mean_Variance/Default_Of_Credit_Card_Client_Data/run.py
```
