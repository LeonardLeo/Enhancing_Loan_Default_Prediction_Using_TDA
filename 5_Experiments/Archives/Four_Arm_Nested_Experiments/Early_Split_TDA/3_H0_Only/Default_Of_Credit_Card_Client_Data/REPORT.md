# Default_Of_Credit_Card_Client_Data — Early_Split_TDA / 3_H0_Only
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Archives/Four_Arm_Nested_Experiments/Early_Split_TDA/3_H0_Only/Default_Of_Credit_Card_Client_Data/run.py
```
