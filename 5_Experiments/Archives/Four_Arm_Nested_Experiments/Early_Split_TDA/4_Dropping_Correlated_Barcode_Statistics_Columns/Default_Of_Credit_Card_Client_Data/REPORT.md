# Default_Of_Credit_Card_Client_Data — Early_Split_TDA / 4_Dropping_Correlated_Barcode_Statistics_Columns
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Archives/Four_Arm_Nested_Experiments/Early_Split_TDA/4_Dropping_Correlated_Barcode_Statistics_Columns/Default_Of_Credit_Card_Client_Data/run.py
```
