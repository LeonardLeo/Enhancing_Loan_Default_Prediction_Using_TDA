...
6_Results/Early_Split_TDA/5_Linear_Regression_For_Prediction/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Archives/Four_Arm_Nested_Experiments/Early_Split_TDA/5_Linear_Regression_For_Prediction/<Dataset>/<script>.py
```
