# -*- coding: utf-8 -*-
"""
Experiment 20 — Persistent Homology (folder name is historical; DL was never implemented)
Dataset: PKDD'99 Czech Financial

Results: 6_Results/Archives/20_Deep_Learning_For_Prediction/PKDD_Czech_Financial/
"""
...
DATA_PATH = "../../../../1_Data/Processed_Datasets/PKDD_Czech_Financial/processed_data.csv"
PCA_COMPONENTS = 10
PERCENTAGES = [10, 20]
RANDOM_STATE = 42
...
# NOTE: This experiment folder is named "Deep_Learning_For_Prediction" for historical
# reasons; deep learning was never implemented. This script runs PH via
# generate_landmark_sets_v2, mirroring the Statlog reference.

EXPERIMENT_NAME = "20_Deep_Learning_For_Prediction"
...
dummy_col = [
    "frequency", "type", "sex", "A2", "A3", "A12", "A15", "preloan_card_type",
]
