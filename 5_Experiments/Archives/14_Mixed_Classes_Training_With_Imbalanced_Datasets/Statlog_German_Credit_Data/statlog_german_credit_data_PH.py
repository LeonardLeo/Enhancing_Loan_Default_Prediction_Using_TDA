...
compute_barcodes_from_multiple_landmarks(landmark_percentages = percentages, # Should be same as used in GENERATE LANDMARK SETS function
                                         landmark_dir = "../../../../1_Data/Landmark_Sets/Statlog_German_Credit_Data/14_Mixed_Classes_Training_With_Imbalanced_Datasets", 
                                         barcode_output_dir = "../../../../1_Data/Barcode_Statistics/Statlog_German_Credit_Data/14_Mixed_Classes_Training_With_Imbalanced_Datasets", 
                                         dim = 2, 
                                         label = {1: "default",
                                                  0: "non-default"})
...
build_final_barcode_statistics_data(landmark_percentages = percentages,
                                    barcode_dir = "../../../../1_Data/Barcode_Statistics/Statlog_German_Credit_Data/14_Mixed_Classes_Training_With_Imbalanced_Datasets",
                                    output_dir = "../../../../1_Data/TDA_Datasets/Statlog_German_Credit_Data/14_Mixed_Classes_Training_With_Imbalanced_Datasets",
                                    label = {1: "default",
                                             0: "non-default"})
...
# =============================================================================
paths = ["../../../../1_Data/TDA_Datasets/Statlog_German_Credit_Data/14_Mixed_Classes_Training_With_Imbalanced_Datasets/data_L30.csv",  
         "../../../../1_Data/TDA_Datasets/Statlog_German_Credit_Data/14_Mixed_Classes_Training_With_Imbalanced_Datasets/data_L60.csv"]
...
# STORE MODEL RESULTS
# =============================================================================
save_path = "../../../../6_Results/Archives/14_Mixed_Classes_Training_With_Imbalanced_Datasets/Statlog_German_Credit_Data"
