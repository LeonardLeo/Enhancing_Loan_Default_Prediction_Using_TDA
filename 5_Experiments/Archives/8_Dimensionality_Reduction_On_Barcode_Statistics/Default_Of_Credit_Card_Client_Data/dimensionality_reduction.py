...
# =============================================================================
dcccd_barcode_stats_default_L5 = pd.read_csv(os.path.abspath("../../../../1_Data/Barcode_Statistics/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Default_Of_Credit_Card_Client_Data/barcode_stats_default_L5.csv"))
dcccd_barcode_stats_default_L15 = pd.read_csv(os.path.abspath("../../../../1_Data/Barcode_Statistics/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Default_Of_Credit_Card_Client_Data/barcode_stats_default_L15.csv"))
dcccd_barcode_stats_non_default_L5 = pd.read_csv(os.path.abspath("../../../../1_Data/Barcode_Statistics/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Default_Of_Credit_Card_Client_Data/barcode_stats_non-default_L5.csv"))
dcccd_barcode_stats_non_default_L15 = pd.read_csv(os.path.abspath("../../../../1_Data/Barcode_Statistics/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Default_Of_Credit_Card_Client_Data/barcode_stats_non-default_L15.csv"))

#%%
# =============================================================================
# Entire Barcode Statistics - Statlog (3_PH_Default_Parameters)
# =============================================================================
dcccd_data_L5 = pd.read_csv(os.path.abspath("../../../../1_Data/TDA_Datasets/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Default_Of_Credit_Card_Client_Data/data_L5.csv"))
dcccd_data_L15 = pd.read_csv(os.path.abspath("../../../../1_Data/TDA_Datasets/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Default_Of_Credit_Card_Client_Data/data_L15.csv"))
...
# PCA ON DATASETS
# =============================================================================
save_path = "../../../../6_Results/Archives/8_Dimensionality_Reduction_On_Barcode_Statistics/Default_Of_Credit_Card_Client_Data/PCA_Results"
