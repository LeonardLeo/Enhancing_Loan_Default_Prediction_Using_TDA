...
For each available matrix, run the shared dimensionality-reduction helper and write figures under `6_Results/Archives/8_Dimensionality_Reduction_On_Barcode_Statistics/{Folder}/`.
