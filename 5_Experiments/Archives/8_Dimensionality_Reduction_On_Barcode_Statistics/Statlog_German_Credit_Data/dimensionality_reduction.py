...
# =============================================================================
sgcd_barcode_stats_default_L30 = pd.read_csv(os.path.abspath("../../../../1_Data/Barcode_Statistics/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Statlog_German_Credit_Data/barcode_stats_default_L30.csv"))
sgcd_barcode_stats_default_L60 = pd.read_csv(os.path.abspath("../../../../1_Data/Barcode_Statistics/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Statlog_German_Credit_Data/barcode_stats_default_L60.csv"))
sgcd_barcode_stats_non_default_L30 = pd.read_csv(os.path.abspath("../../../../1_Data/Barcode_Statistics/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Statlog_German_Credit_Data/barcode_stats_non-default_L30.csv"))
sgcd_barcode_stats_non_default_L60 = pd.read_csv(os.path.abspath("../../../../1_Data/Barcode_Statistics/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Statlog_German_Credit_Data/barcode_stats_non-default_L60.csv"))

#%%
# =============================================================================
# Entire Barcode Statistics - Statlog (3_PH_Default_Parameters)
# =============================================================================
sgcd_data_L30 = pd.read_csv(os.path.abspath("../../../../1_Data/TDA_Datasets/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Statlog_German_Credit_Data/data_L30.csv"))
sgcd_data_L60 = pd.read_csv(os.path.abspath("../../../../1_Data/TDA_Datasets/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Statlog_German_Credit_Data/data_L60.csv"))
...
# PCA ON DATASETS
# =============================================================================
save_path = "../../../../6_Results/Archives/8_Dimensionality_Reduction_On_Barcode_Statistics/Statlog_German_Credit_Data/PCA_Results"
