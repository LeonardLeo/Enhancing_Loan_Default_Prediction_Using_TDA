...
from utils import (train_multiple_knn_datasets,
...
generate_landmark_sets(class_label_and_data = {"default": default_data.copy().drop("Class", 
                       ...
                       experiment_name = "15_Working_With_K_in_KNN")
...
compute_barcodes_from_multiple_landmarks(landmark_percentages = percentages, # Should be same as used in GENERATE LANDMARK SETS function
                                         landmark_dir = "../../../../1_Data/Landmark_Sets/Default_Of_Credit_Card_Client_Data/15_Working_With_K_in_KNN", 
                                         barcode_output_dir = "../../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/15_Working_With_K_in_KNN", 
                                         dim = 2, 
                                         label = {1: "default",
                                                  0: "non-default"})
...
build_final_barcode_statistics_data(landmark_percentages = percentages,
                                    barcode_dir = "../../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/15_Working_With_K_in_KNN",
                                    output_dir = "../../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/15_Working_With_K_in_KNN",
                                    label = {1: "default",
                                             0: "non-default"})
...
# =============================================================================
paths = ["../../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/15_Working_With_K_in_KNN/data_L5.csv", 
         "../../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/15_Working_With_K_in_KNN/data_L15.csv",]

model_results = train_multiple_knn_datasets(path_datasets = paths,
                                           y_col_name = "label",
                                           test_size = 0.2,
                                           random_state = 42,
                                           base_output_path = "../../../../6_Results/Archives/15_Working_With_K_in_KNN/Default_Of_Credit_Card_Client_Data")
...
# STORE MODEL RESULTS
# =============================================================================
save_path = "../../../../6_Results/Archives/15_Working_With_K_in_KNN/Default_Of_Credit_Card_Client_Data"
