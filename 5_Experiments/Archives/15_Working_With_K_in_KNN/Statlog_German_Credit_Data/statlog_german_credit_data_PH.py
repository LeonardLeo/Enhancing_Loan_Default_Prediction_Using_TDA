...
compute_barcodes_from_multiple_landmarks(landmark_percentages = percentages, # Should be same as used in GENERATE LANDMARK SETS function
                                         landmark_dir = "../../../../1_Data/Landmark_Sets/Statlog_German_Credit_Data/15_Working_With_K_in_KNN", 
                                         barcode_output_dir = "../../../../1_Data/Barcode_Statistics/Statlog_German_Credit_Data/15_Working_With_K_in_KNN", 
                                         dim = 2, 
                                         label = {1: "default",
                                                  0: "non-default"})
...
build_final_barcode_statistics_data(landmark_percentages = percentages,
                                    barcode_dir = "../../../../1_Data/Barcode_Statistics/Statlog_German_Credit_Data/15_Working_With_K_in_KNN",
                                    output_dir = "../../../../1_Data/TDA_Datasets/Statlog_German_Credit_Data/15_Working_With_K_in_KNN",
                                    label = {1: "default",
                                             0: "non-default"})
...
# =============================================================================
paths = ["../../../../1_Data/TDA_Datasets/Statlog_German_Credit_Data/15_Working_With_K_in_KNN/data_L30.csv",  
         "../../../../1_Data/TDA_Datasets/Statlog_German_Credit_Data/15_Working_With_K_in_KNN/data_L60.csv"]

model_results = train_multiple_knn_datasets(path_datasets = paths,
                                           y_col_name = "label",
                                           test_size = 0.2,
                                           random_state = 42,
                                           base_output_path = "../../../../6_Results/Archives/15_Working_With_K_in_KNN/Statlog_German_Credit_Data")
...
# STORE MODEL RESULTS
# =============================================================================
save_path = "../../../../6_Results/Archives/15_Working_With_K_in_KNN/Statlog_German_Credit_Data"
