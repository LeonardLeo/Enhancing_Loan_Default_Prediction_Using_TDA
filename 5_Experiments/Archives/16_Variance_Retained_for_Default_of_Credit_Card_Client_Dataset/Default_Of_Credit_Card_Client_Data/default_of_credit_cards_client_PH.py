...
# =============================================================================
results = run_experiments_with_pca_components(data_path = r"../../../../1_Data/Processed_Datasets/Default_Of_Credit_Card_Client_Data/processed_data.xlsx",
                                              target_column = "default payment next month",
                                              components_list = [2, 3, 5, 7, 9, 11, 13, 15, 17, 19],
                                              percentages = [5, 15],
                                              landmark_dir = "../../../../1_Data/Landmark_Sets/Default_Of_Credit_Card_Client_Data/16_Variance_Retained_for_Default_of_Credit_Card_Client_Dataset",
                                              base_output_dir = "../../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/16_Variance_Retained_for_Default_of_Credit_Card_Client_Dataset",
                                              output_dir = "../../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/16_Variance_Retained_for_Default_of_Credit_Card_Client_Dataset",
                                              results_save_path = "../../../../6_Results/Archives/16_Variance_Retained_for_Default_of_Credit_Card_Client_Dataset/Default_Of_Credit_Card_Client_Data",
                                              dataset_to_use = "dataset2",
                                              homology_dimension = 2,
                                              add_optional_path = True,
                                              test_size = 0.2,
                                              random_state = 42,
                                              experiment_name = "16_Variance_Retained_for_Default_of_Credit_Card_Client_Dataset")

# =============================================================================
# Store Results
# =============================================================================
save_path = "../../../../6_Results/Archives/16_Variance_Retained_for_Default_of_Credit_Card_Client_Dataset/Default_Of_Credit_Card_Client_Data"
...
plot_results_knn = plot_all_metrics_vs_pca_components(all_results = results,
                                                      model_key = "knn",
                                                      save_path = "../../../../6_Results/Archives/16_Variance_Retained_for_Default_of_Credit_Card_Client_Dataset/Default_Of_Credit_Card_Client_Data/viz",
                                                      separate_plots = True)
