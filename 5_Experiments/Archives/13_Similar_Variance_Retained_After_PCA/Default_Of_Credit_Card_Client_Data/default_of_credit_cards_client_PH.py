...
X_reduced = pd.DataFrame(pca.fit_transform(X_normalized), columns = [f"PCA_{num}" for num in range(1, 6)])
...
# =============================================================================
percentages = [5, 15] # CHANGES MADE HERE
...
compute_barcodes_from_multiple_landmarks(landmark_percentages = percentages, # Should be same as used in GENERATE LANDMARK SETS function
                                         landmark_dir = "../../../../1_Data/Landmark_Sets/Default_Of_Credit_Card_Client_Data/13_Similar_Variance_Retained_After_PCA", 
                                         barcode_output_dir = "../../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/13_Similar_Variance_Retained_After_PCA", 
                                         dim = 2, 
                                         label = {1: "default",
                                                  0: "non-default"})
...
build_final_barcode_statistics_data(landmark_percentages = percentages,
                                    barcode_dir = "../../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/13_Similar_Variance_Retained_After_PCA",
                                    output_dir = "../../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/13_Similar_Variance_Retained_After_PCA",
                                    label = {1: "default",
                                             0: "non-default"})
...
# =============================================================================
paths = ["../../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/13_Similar_Variance_Retained_After_PCA/data_L5.csv", 
         "../../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/13_Similar_Variance_Retained_After_PCA/data_L15.csv",]
...
# STORE MODEL RESULTS
# =============================================================================
save_path = "../../../../6_Results/Archives/13_Similar_Variance_Retained_After_PCA/Default_Of_Credit_Card_Client_Data"
