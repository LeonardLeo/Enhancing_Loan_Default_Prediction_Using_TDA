...
# =============================================================================
percentages = [1.36, 2.71] # CHANGES MADE HERE
...
compute_barcodes_from_multiple_landmarks(landmark_percentages = percentages, # Should be same as used in GENERATE LANDMARK SETS function
                                         landmark_dir = "../../../../1_Data/Landmark_Sets/Default_Of_Credit_Card_Client_Data/12_Equivalent_Sample_Size_For_Each_Dataset", 
                                         barcode_output_dir = "../../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/12_Equivalent_Sample_Size_For_Each_Dataset", 
                                         dim = 2, 
                                         label = {1: "default",
                                                  0: "non-default"})
...
build_final_barcode_statistics_data(landmark_percentages = percentages,
                                    barcode_dir = "../../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/12_Equivalent_Sample_Size_For_Each_Dataset",
                                    output_dir = "../../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/12_Equivalent_Sample_Size_For_Each_Dataset",
                                    label = {1: "default",
                                             0: "non-default"})
...
# =============================================================================
paths = ["../../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/12_Equivalent_Sample_Size_For_Each_Dataset/data_L1.36.csv", 
         "../../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/12_Equivalent_Sample_Size_For_Each_Dataset/data_L2.71.csv",]
...
# STORE MODEL RESULTS
# =============================================================================
save_path = "../../../../6_Results/Archives/12_Equivalent_Sample_Size_For_Each_Dataset/Default_Of_Credit_Card_Client_Data"
