...
compute_barcodes_from_multiple_landmarks(landmark_percentages = percentages, # Should be same as used in GENERATE LANDMARK SETS function
                                         landmark_dir = "../../../1_Data/Landmark_Sets/Statlog_German_Credit_Data/6_Experiment_Impact_of_H0_Only", 
                                         barcode_output_dir = "../../../1_Data/Barcode_Statistics/Statlog_German_Credit_Data/6_Experiment_Impact_of_H0_Only", 
                                         dim = 1, 
                                         label = {1: "default",
                                                  0: "non-default"})
...
build_final_barcode_statistics_data(landmark_percentages = percentages,
                                    barcode_dir = "../../../1_Data/Barcode_Statistics/Statlog_German_Credit_Data/6_Experiment_Impact_of_H0_Only",
                                    output_dir = "../../../1_Data/TDA_Datasets/Statlog_German_Credit_Data/6_Experiment_Impact_of_H0_Only",
                                    label = {1: "default",
                                             0: "non-default"})
...
# =============================================================================
paths = ["../../../1_Data/TDA_Datasets/Statlog_German_Credit_Data/6_Experiment_Impact_of_H0_Only/data_L30.csv",  
...
# STORE MODEL RESULTS
# =============================================================================
save_path = "../../../6_Results/6_Experiment_Impact_of_H0_Only/Statlog_German_Credit_Data"
