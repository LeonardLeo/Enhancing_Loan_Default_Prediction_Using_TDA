...
compute_barcodes_from_multiple_landmarks(
    landmark_percentages=percentages,
    landmark_dir="../../../1_Data/Landmark_Sets/Taiwan_Bankruptcy/6_Experiment_Impact_of_H0_Only",
    barcode_output_dir="../../../1_Data/Barcode_Statistics/Taiwan_Bankruptcy/6_Experiment_Impact_of_H0_Only",
    dim=1,
...
build_final_barcode_statistics_data(
    landmark_percentages=percentages,
    barcode_dir="../../../1_Data/Barcode_Statistics/Taiwan_Bankruptcy/6_Experiment_Impact_of_H0_Only",
    output_dir="../../../1_Data/TDA_Datasets/Taiwan_Bankruptcy/6_Experiment_Impact_of_H0_Only",
    label={1: "default", 0: "non-default"},
)
...
# =============================================================================
paths = [
    "../../../1_Data/TDA_Datasets/Taiwan_Bankruptcy/6_Experiment_Impact_of_H0_Only/data_L10.csv",
    "../../../1_Data/TDA_Datasets/Taiwan_Bankruptcy/6_Experiment_Impact_of_H0_Only/data_L20.csv",
]
...
# STORE MODEL RESULTS
# =============================================================================
save_path = "../../../6_Results/6_Experiment_Impact_of_H0_Only/Taiwan_Bankruptcy"
