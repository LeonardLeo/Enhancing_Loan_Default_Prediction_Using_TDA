...
Results: 6_Results/Historical_Late_Split_Balanced_TDA/6_Sampling_Ratio_Audit/Default_Of_Credit_Card_Client_Data/
"""
...
POSITIVE_LABEL = 1
LANDMARK_PERCENTS = [5, 15]
HISTORICAL_L = 500  # snapshot count used in Experiment 3
SAVE_PATH = f"../../../../6_Results/Historical_Late_Split_Balanced_TDA/6_Sampling_Ratio_Audit/{FOLDER}"

# =============================================================================
# Stage 1 — Load processed data
# =============================================================================
dataset = pd.read_excel(os.path.abspath("../../../../1_Data/Processed_Datasets/Default_Of_Credit_Card_Client_Data/processed_data.xlsx"))
