...
Results: 6_Results/Historical_Late_Split_Balanced_TDA/6_Sampling_Ratio_Audit/PKDD_Czech_Financial/
"""
...
# =============================================================================
dataset = pd.read_csv(os.path.abspath("../../../../1_Data/Processed_Datasets/PKDD_Czech_Financial/processed_data.csv"))
