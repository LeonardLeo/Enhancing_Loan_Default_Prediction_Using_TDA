# PKDD_Czech_Financial — Historical_Late_Split_Balanced_TDA / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/6_Sampling_Ratio_Audit/PKDD_Czech_Financial/run.py
```
