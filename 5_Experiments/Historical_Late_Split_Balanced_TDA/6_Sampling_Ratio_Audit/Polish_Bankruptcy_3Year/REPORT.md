# Polish_Bankruptcy_3Year — Historical_Late_Split_Balanced_TDA / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/6_Sampling_Ratio_Audit/Polish_Bankruptcy_3Year/run.py
```
