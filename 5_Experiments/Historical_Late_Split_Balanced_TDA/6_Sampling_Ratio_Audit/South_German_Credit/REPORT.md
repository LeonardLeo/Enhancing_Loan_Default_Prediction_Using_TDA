# South_German_Credit — Historical_Late_Split_Balanced_TDA / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/6_Sampling_Ratio_Audit/South_German_Credit/run.py
```
