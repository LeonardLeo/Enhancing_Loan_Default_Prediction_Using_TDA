...
Results: 6_Results/Historical_Late_Split_Balanced_TDA/6_Sampling_Ratio_Audit/South_German_Credit/
"""
...
# =============================================================================
dataset = pd.read_csv(os.path.abspath("../../../../1_Data/Processed_Datasets/South_German_Credit/processed_data.csv"))
