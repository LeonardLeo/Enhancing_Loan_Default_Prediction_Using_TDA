# -*- coding: utf-8 -*-
"""Run 6_Sampling_Ratio_Audit for every dataset in Historical_Late_Split_Balanced_TDA."""
...
def main() -> int:
    ...
    for folder in DATASETS:
        ...
        if script is None:
            ...
            continue
        print("=" * 72)
        print(f"Historical_Late_Split_Balanced_TDA / 6_Sampling_Ratio_Audit — {folder}")
        print(script)
        print("=" * 72)
