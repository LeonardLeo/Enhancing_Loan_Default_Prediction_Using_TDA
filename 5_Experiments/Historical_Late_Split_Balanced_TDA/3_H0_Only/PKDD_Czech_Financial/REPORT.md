# PKDD_Czech_Financial — Historical_Late_Split_Balanced_TDA / 3_H0_Only
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/3_H0_Only/PKDD_Czech_Financial/run.py
```
