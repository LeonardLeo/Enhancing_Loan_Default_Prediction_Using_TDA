# Default_Of_Credit_Card_Client_Data — Historical_Late_Split_Balanced_TDA / 2_PH_Tuned_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/2_PH_Tuned_Parameters/Default_Of_Credit_Card_Client_Data/run.py
```
