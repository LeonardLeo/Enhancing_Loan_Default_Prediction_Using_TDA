# PKDD_Czech_Financial — Historical_Late_Split_Balanced_TDA / 2_PH_Tuned_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/2_PH_Tuned_Parameters/PKDD_Czech_Financial/run.py
```
