# -*- coding: utf-8 -*-
"""Run 2_PH_Tuned_Parameters for every dataset in Historical_Late_Split_Balanced_TDA."""
...
def main() -> int:
    ...
    for folder in DATASETS:
        ...
        if script is None:
            ...
            continue
        print("=" * 72)
        print(f"Historical_Late_Split_Balanced_TDA / 2_PH_Tuned_Parameters — {folder}")
        print(script)
        print("=" * 72)
