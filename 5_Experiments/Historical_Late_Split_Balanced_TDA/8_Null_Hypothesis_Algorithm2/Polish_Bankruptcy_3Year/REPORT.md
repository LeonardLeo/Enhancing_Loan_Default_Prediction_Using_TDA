# Polish_Bankruptcy_3Year — Historical_Late_Split_Balanced_TDA / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/8_Null_Hypothesis_Algorithm2/Polish_Bankruptcy_3Year/run.py
```
