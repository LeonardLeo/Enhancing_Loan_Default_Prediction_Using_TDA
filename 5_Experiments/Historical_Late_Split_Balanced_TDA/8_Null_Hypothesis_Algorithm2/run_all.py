# -*- coding: utf-8 -*-
"""Run 8_Null_Hypothesis_Algorithm2 for every dataset in Historical_Late_Split_Balanced_TDA."""
...
def main() -> int:
    ...
    for folder in DATASETS:
        ...
        if script is None:
            ...
            continue
        print("=" * 72)
        print(f"Historical_Late_Split_Balanced_TDA / 8_Null_Hypothesis_Algorithm2 — {folder}")
        print(script)
        print("=" * 72)
