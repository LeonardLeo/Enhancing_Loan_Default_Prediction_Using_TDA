# -*- coding: utf-8 -*-
"""Run 5_Linear_Regression_For_Prediction for every dataset in Historical_Late_Split_Balanced_TDA."""
...
def main() -> int:
    ...
    for folder in DATASETS:
        ...
        if script is None:
            ...
            continue
        print("=" * 72)
        print(f"Historical_Late_Split_Balanced_TDA / 5_Linear_Regression_For_Prediction — {folder}")
        print(script)
        print("=" * 72)
