# PKDD_Czech_Financial — Historical_Late_Split_Balanced_TDA / 5_Linear_Regression_For_Prediction
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/5_Linear_Regression_For_Prediction/PKDD_Czech_Financial/run.py
```
