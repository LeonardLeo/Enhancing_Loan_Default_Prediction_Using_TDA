# -*- coding: utf-8 -*-
"""Run 7_Snapshot_Mean_Variance for every dataset in Historical_Late_Split_Balanced_TDA."""
...
def main() -> int:
    ...
    for folder in DATASETS:
        ...
        if script is None:
            ...
            continue
        print("=" * 72)
        print(f"Historical_Late_Split_Balanced_TDA / 7_Snapshot_Mean_Variance — {folder}")
        print(script)
        print("=" * 72)
