# Polish_Bankruptcy_3Year — Historical_Late_Split_Balanced_TDA / 7_Snapshot_Mean_Variance
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/7_Snapshot_Mean_Variance/Polish_Bankruptcy_3Year/run.py
```
