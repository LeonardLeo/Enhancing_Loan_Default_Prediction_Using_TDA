# Historical_Late_Split_Balanced_TDA — Experiment 9 (revised snapshot protocol)
...
Numeric dump: `6_Results/Historical_Late_Split_Balanced_TDA/9_Revised_Snapshot_Protocol/` (including `all_designs.json`). Figures: `6_Results/Historical_Late_Split_Balanced_TDA/9_Revised_Snapshot_Protocol/Visualizations/`.
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/9_Revised_Snapshot_Protocol/run_protocol.py --stage all
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/9_Revised_Snapshot_Protocol/run_protocol.py --stage design
.\tda_env\Scripts\python.exe 5_Experiments/Historical_Late_Split_Balanced_TDA/9_Revised_Snapshot_Protocol/Statlog_German_Credit_Data/statlog_german_credit_protocol.py
```
