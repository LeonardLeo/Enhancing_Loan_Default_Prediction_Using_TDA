...
# GET DATASET
# =============================================================================
TDA_DIR = tda_artefact_dir("TDA_Datasets", "Historical_Late_Split_Balanced_TDA", "1_PH_Default_Parameters", "Taiwan_Bankruptcy")
if not (TDA_DIR / "data_L10.csv").exists() or not (TDA_DIR / "data_L20.csv").exists():
    raise SystemExit(
        f"Missing Historical Exp 1 matrices under {TDA_DIR}. "
        "Run 5_Experiments/Historical_Late_Split_Balanced_TDA/1_PH_Default_Parameters/Taiwan_Bankruptcy/ first."
    )
...
# =============================================================================
save_path_var = str(tda_artefact_dir("TDA_Datasets", "Historical_Late_Split_Balanced_TDA", "4_Dropping_Correlated_Barcode_Statistics_Columns", "Taiwan_Bankruptcy", "Using_High_Variance_For_Correlation"))
save_path_target = str(tda_artefact_dir("TDA_Datasets", "Historical_Late_Split_Balanced_TDA", "4_Dropping_Correlated_Barcode_Statistics_Columns", "Taiwan_Bankruptcy", "Using_Target_Variable_For_Correlation"))
save_path_results = str(tda_results_dir("Historical_Late_Split_Balanced_TDA", "4_Dropping_Correlated_Barcode_Statistics_Columns", "Taiwan_Bankruptcy"))
