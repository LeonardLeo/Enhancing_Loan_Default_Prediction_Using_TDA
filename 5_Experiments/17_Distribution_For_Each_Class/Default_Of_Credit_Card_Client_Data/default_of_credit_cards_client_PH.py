...
#  Load the dataset
# =============================================================================
data_paths = [r"../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/3_PH_Default_Parameters/data_L5.csv",
             r"../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/3_PH_Default_Parameters/data_L15.csv"]
...
viz_tsne = visualize_class_separability(
            ...
            label_column = "label",
            save_path = "../../../6_Results/17_Distribution_For_Each_Class/Default_Of_Credit_Card_Client_Data",
...
viz_tsne_kernel_density = visualize_class_separability(
            ...
            method = "tsne",  # or 'pca' or 'umap'
            label_column = "label",
            save_path = "../../../6_Results/17_Distribution_For_Each_Class/Default_Of_Credit_Card_Client_Data/kernel_density",
...
viz_pca_3d = visualize_class_separability(
            ...
            save_path = "../../../6_Results/17_Distribution_For_Each_Class/Default_Of_Credit_Card_Client_Data/3D",
            show_legend = True,
...
animated_viz_tsne_3d = visualize_class_separability(
            ...
            save_gif = True,
            animated_plot_path = "../../../6_Results/17_Distribution_For_Each_Class/Default_Of_Credit_Card_Client_Data/animated_3D",
            title = "3D TDA Class Separability Using"
)
