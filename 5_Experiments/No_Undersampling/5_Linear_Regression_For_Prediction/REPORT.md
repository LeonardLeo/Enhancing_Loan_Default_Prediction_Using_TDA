...
6_Results/No_Undersampling/5_Linear_Regression_For_Prediction/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/5_Linear_Regression_For_Prediction/<Dataset>/<script>.py
```
