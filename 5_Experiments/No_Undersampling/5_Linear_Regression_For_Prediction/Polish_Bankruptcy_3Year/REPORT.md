# Polish_Bankruptcy_3Year — No_Undersampling / 5_Linear_Regression_For_Prediction
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/5_Linear_Regression_For_Prediction/Polish_Bankruptcy_3Year/run.py
```
