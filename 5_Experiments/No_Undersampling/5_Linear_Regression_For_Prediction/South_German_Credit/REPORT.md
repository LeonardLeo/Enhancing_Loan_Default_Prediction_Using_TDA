# South_German_Credit — No_Undersampling / 5_Linear_Regression_For_Prediction
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/5_Linear_Regression_For_Prediction/South_German_Credit/run.py
```
