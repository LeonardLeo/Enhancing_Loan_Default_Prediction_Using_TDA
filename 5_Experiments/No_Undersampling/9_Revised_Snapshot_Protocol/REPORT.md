...
5_Experiments/No_Undersampling/9_Revised_Snapshot_Protocol/PKDD_Czech_Financial/pkdd_czech_financial_protocol.py
...
```
...
Numeric dump: `6_Results/No_Undersampling/9_Revised_Snapshot_Protocol/` (including `all_designs.json`).
...
```
python 5_Experiments/No_Undersampling/9_Revised_Snapshot_Protocol/Statlog_German_Credit_Data/statlog_german_credit_protocol.py
```
