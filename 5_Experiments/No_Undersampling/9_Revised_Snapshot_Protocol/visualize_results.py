# -*- coding: utf-8 -*-
"""Visualize artefacts for No_Undersampling / 9_Revised_Snapshot_Protocol.

Runnable from this experiment directory:

    python visualize_results.py

Run this script; figures land in `6_Results/No_Undersampling/9_Revised_Snapshot_Protocol/Visualizations/`.
