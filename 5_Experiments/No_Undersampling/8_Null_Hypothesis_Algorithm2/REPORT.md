# No_Undersampling — 8_Null_Hypothesis_Algorithm2
...
| Snapshot size | t = floor(n_class * L / 100) per class on the unbalanced pool |
...
6_Results/No_Undersampling/8_Null_Hypothesis_Algorithm2/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/8_Null_Hypothesis_Algorithm2/<Dataset>/<script>.py
```
