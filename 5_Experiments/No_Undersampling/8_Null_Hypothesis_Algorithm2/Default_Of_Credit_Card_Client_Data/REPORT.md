# Default_Of_Credit_Card_Client_Data — No_Undersampling / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/8_Null_Hypothesis_Algorithm2/Default_Of_Credit_Card_Client_Data/run.py
```
