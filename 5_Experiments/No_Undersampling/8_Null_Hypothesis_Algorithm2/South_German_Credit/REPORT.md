# South_German_Credit — No_Undersampling / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/8_Null_Hypothesis_Algorithm2/South_German_Credit/run.py
```
