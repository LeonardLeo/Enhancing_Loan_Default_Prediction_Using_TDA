# Taiwan_Bankruptcy — No_Undersampling / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/8_Null_Hypothesis_Algorithm2/Taiwan_Bankruptcy/run.py
```
