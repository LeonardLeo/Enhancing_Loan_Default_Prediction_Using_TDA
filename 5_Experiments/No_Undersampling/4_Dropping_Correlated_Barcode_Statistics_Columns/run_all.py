# -*- coding: utf-8 -*-
"""Run 4_Dropping_Correlated_Barcode_Statistics_Columns for every dataset in No_Undersampling."""
...
def main() -> int:
    ...
    for folder in DATASETS:
        ...
        if script is None:
            ...
            continue
        print("=" * 72)
        print(f"No_Undersampling / 4_Dropping_Correlated_Barcode_Statistics_Columns — {folder}")
        print(script)
        print("=" * 72)
