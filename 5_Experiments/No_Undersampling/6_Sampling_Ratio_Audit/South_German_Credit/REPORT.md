# South_German_Credit — No_Undersampling / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/6_Sampling_Ratio_Audit/South_German_Credit/run.py
```
