# PKDD_Czech_Financial — No_Undersampling / 2_PH_Tuned_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/2_PH_Tuned_Parameters/PKDD_Czech_Financial/run.py
```
