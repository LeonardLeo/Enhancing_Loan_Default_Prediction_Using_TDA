# Default_Of_Credit_Card_Client_Data — No_Undersampling / 2_PH_Tuned_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/2_PH_Tuned_Parameters/Default_Of_Credit_Card_Client_Data/run.py
```
