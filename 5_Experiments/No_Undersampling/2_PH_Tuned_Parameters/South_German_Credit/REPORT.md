# South_German_Credit — No_Undersampling / 2_PH_Tuned_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/2_PH_Tuned_Parameters/South_German_Credit/run.py
```
