# Statlog_German_Credit_Data — No_Undersampling / 7_Snapshot_Mean_Variance
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/7_Snapshot_Mean_Variance/Statlog_German_Credit_Data/run.py
```
