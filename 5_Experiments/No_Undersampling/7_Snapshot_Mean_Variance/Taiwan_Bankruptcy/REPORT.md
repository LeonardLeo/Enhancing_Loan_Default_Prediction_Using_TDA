# Taiwan_Bankruptcy — No_Undersampling / 7_Snapshot_Mean_Variance
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/7_Snapshot_Mean_Variance/Taiwan_Bankruptcy/run.py
```
