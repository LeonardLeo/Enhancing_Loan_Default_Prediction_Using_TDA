...
6_Results/No_Undersampling/7_Snapshot_Mean_Variance/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/7_Snapshot_Mean_Variance/<Dataset>/<script>.py
```
