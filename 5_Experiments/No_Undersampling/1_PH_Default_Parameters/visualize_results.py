# -*- coding: utf-8 -*-
"""Visualize artefacts for No_Undersampling / 1_PH_Default_Parameters.

Runnable from this experiment directory:

    python visualize_results.py

Run this script; figures land in `6_Results/No_Undersampling/1_PH_Default_Parameters/Visualizations/`.
