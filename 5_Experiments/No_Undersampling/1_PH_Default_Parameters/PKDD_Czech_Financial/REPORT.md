# PKDD_Czech_Financial — No_Undersampling / 1_PH_Default_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/1_PH_Default_Parameters/PKDD_Czech_Financial/run.py
```
