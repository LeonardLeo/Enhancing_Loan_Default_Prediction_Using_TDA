# Polish_Bankruptcy_3Year — No_Undersampling / 1_PH_Default_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/No_Undersampling/1_PH_Default_Parameters/Polish_Bankruptcy_3Year/run.py
```
