# Early_Split_TDA_And_No_Undersampling — 4_Dropping_Correlated_Barcode_Statistics_Columns
...
| Snapshot size | t = floor(n_class * L / 100) per class on that split's available pool |
...
6_Results/Early_Split_TDA_And_No_Undersampling/4_Dropping_Correlated_Barcode_Statistics_Columns/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/4_Dropping_Correlated_Barcode_Statistics_Columns/<Dataset>/<script>.py
```
