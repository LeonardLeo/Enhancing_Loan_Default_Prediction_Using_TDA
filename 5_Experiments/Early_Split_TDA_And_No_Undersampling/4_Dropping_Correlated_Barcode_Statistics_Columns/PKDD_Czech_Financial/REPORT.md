# PKDD_Czech_Financial — Early_Split_TDA_And_No_Undersampling / 4_Dropping_Correlated_Barcode_Statistics_Columns
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/4_Dropping_Correlated_Barcode_Statistics_Columns/PKDD_Czech_Financial/run.py
```
