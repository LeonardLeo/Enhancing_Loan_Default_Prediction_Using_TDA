...
6_Results/Early_Split_TDA_And_No_Undersampling/7_Snapshot_Mean_Variance/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/7_Snapshot_Mean_Variance/<Dataset>/<script>.py
```
