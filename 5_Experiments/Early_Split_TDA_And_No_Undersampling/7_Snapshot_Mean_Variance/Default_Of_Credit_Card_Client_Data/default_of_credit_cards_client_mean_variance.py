...
# =============================================================================
# Mean and variance - L5 TRAIN
# =============================================================================
path_train_L5 = os.path.join(src_dir, "train", "data_L5.csv")
if os.path.exists(path_train_L5):
    summary_path_train_L5 = summarize_snapshot_statistics(path_train_L5)
    key_path_train_L5 = path_train_L5.replace(os.path.join(REPO_ROOT, "1_Data", "TDA_Datasets") + os.sep, "")
    all_summaries[key_path_train_L5] = summary_path_train_L5
    flat_rows.extend(flatten_snapshot_mean_variance(summary_path_train_L5, key_path_train_L5))
    print("OK", os.path.basename(path_train_L5), "n=", summary_path_train_L5["n_snapshots"])
else:
    print("Missing (run this arm's experiment 1 first):", path_train_L5)
# =============================================================================
# Mean and variance - L5 TEST
# =============================================================================
path_test_L5 = os.path.join(src_dir, "test", "data_L5.csv")
if os.path.exists(path_test_L5):
    summary_path_test_L5 = summarize_snapshot_statistics(path_test_L5)
    key_path_test_L5 = path_test_L5.replace(os.path.join(REPO_ROOT, "1_Data", "TDA_Datasets") + os.sep, "")
    all_summaries[key_path_test_L5] = summary_path_test_L5
    flat_rows.extend(flatten_snapshot_mean_variance(summary_path_test_L5, key_path_test_L5))
    print("OK", os.path.basename(path_test_L5), "n=", summary_path_test_L5["n_snapshots"])
else:
    print("Missing (run this arm's experiment 1 first):", path_test_L5)
# =============================================================================
# Mean and variance - L15 TRAIN
# =============================================================================
path_train_L15 = os.path.join(src_dir, "train", "data_L15.csv")
if os.path.exists(path_train_L15):
    summary_path_train_L15 = summarize_snapshot_statistics(path_train_L15)
    key_path_train_L15 = path_train_L15.replace(os.path.join(REPO_ROOT, "1_Data", "TDA_Datasets") + os.sep, "")
    all_summaries[key_path_train_L15] = summary_path_train_L15
    flat_rows.extend(flatten_snapshot_mean_variance(summary_path_train_L15, key_path_train_L15))
    print("OK", os.path.basename(path_train_L15), "n=", summary_path_train_L15["n_snapshots"])
else:
    print("Missing (run this arm's experiment 1 first):", path_train_L15)
# =============================================================================
# Mean and variance - L15 TEST
# =============================================================================
path_test_L15 = os.path.join(src_dir, "test", "data_L15.csv")
if os.path.exists(path_test_L15):
    summary_path_test_L15 = summarize_snapshot_statistics(path_test_L15)
    key_path_test_L15 = path_test_L15.replace(os.path.join(REPO_ROOT, "1_Data", "TDA_Datasets") + os.sep, "")
    all_summaries[key_path_test_L15] = summary_path_test_L15
    flat_rows.extend(flatten_snapshot_mean_variance(summary_path_test_L15, key_path_test_L15))
    print("OK", os.path.basename(path_test_L15), "n=", summary_path_test_L15["n_snapshots"])
else:
