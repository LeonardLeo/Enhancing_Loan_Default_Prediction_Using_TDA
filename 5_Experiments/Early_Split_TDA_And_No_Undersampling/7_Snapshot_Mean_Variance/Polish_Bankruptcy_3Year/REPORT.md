# Polish_Bankruptcy_3Year — Early_Split_TDA_And_No_Undersampling / 7_Snapshot_Mean_Variance
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/7_Snapshot_Mean_Variance/Polish_Bankruptcy_3Year/run.py
```
