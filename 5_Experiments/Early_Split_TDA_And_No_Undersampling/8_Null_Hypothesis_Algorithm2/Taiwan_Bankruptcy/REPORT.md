# Taiwan_Bankruptcy — Early_Split_TDA_And_No_Undersampling / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/8_Null_Hypothesis_Algorithm2/Taiwan_Bankruptcy/run.py
```
