# -*- coding: utf-8 -*-
"""Run 3_H0_Only for every dataset in Early_Split_TDA_And_No_Undersampling."""
...
def main() -> int:
    ...
    for folder in DATASETS:
        ...
        if script is None:
            ...
            continue
        print("=" * 72)
        print(f"Early_Split_TDA_And_No_Undersampling / 3_H0_Only — {folder}")
        print(script)
        print("=" * 72)
    ...
    if failed:
        ...
        return 1
    print("3_H0_Only finished for all six datasets.")
    return 0
