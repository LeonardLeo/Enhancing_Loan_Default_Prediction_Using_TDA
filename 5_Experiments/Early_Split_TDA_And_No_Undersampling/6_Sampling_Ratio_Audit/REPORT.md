# Early_Split_TDA_And_No_Undersampling — 6_Sampling_Ratio_Audit
...
6_Results/Early_Split_TDA_And_No_Undersampling/6_Sampling_Ratio_Audit/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/6_Sampling_Ratio_Audit/<Dataset>/<script>.py
```
