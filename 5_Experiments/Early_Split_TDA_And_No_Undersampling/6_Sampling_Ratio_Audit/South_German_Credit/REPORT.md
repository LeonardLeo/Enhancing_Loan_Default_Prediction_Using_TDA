# South_German_Credit — Early_Split_TDA_And_No_Undersampling / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/6_Sampling_Ratio_Audit/South_German_Credit/run.py
```
