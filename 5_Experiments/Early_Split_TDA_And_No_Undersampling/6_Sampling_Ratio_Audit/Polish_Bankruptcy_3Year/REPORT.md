# Polish_Bankruptcy_3Year — Early_Split_TDA_And_No_Undersampling / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/6_Sampling_Ratio_Audit/Polish_Bankruptcy_3Year/run.py
```
