# -*- coding: utf-8 -*-
"""Run 6_Sampling_Ratio_Audit for every dataset in Early_Split_TDA_And_No_Undersampling."""
...
def main() -> int:
    ...
    for folder in DATASETS:
        ...
        if script is None:
            ...
            continue
        print("=" * 72)
        print(f"Early_Split_TDA_And_No_Undersampling / 6_Sampling_Ratio_Audit — {folder}")
        print(script)
        print("=" * 72)
    ...
    if failed:
        ...
        return 1
    print("6_Sampling_Ratio_Audit finished for all six datasets.")
    return 0
