...
6_Results/Early_Split_TDA_And_No_Undersampling/2_PH_Tuned_Parameters/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/2_PH_Tuned_Parameters/<Dataset>/<script>.py
```
