# South_German_Credit — Early_Split_TDA_And_No_Undersampling / 2_PH_Tuned_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/2_PH_Tuned_Parameters/South_German_Credit/run.py
```
