# Taiwan_Bankruptcy — Early_Split_TDA_And_No_Undersampling / 1_PH_Default_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/1_PH_Default_Parameters/Taiwan_Bankruptcy/run.py
```
