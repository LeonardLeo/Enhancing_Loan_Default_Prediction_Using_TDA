# -*- coding: utf-8 -*-
"""Visualize artefacts for Early_Split_TDA_And_No_Undersampling / 1_PH_Default_Parameters.

Runnable from this experiment directory:

    python visualize_results.py

Run this script; figures land in `6_Results/Early_Split_TDA_And_No_Undersampling/1_PH_Default_Parameters/Visualizations/`.
