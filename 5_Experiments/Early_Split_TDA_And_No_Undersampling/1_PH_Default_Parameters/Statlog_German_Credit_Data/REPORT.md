# Statlog_German_Credit_Data — Early_Split_TDA_And_No_Undersampling / 1_PH_Default_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_TDA_And_No_Undersampling/1_PH_Default_Parameters/Statlog_German_Credit_Data/run.py
```
