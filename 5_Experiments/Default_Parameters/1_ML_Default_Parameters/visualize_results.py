# -*- coding: utf-8 -*-
"""Visualize artefacts for Default_Parameters / 1_ML_Default_Parameters.

Runnable from this experiment directory:

    python visualize_results.py

Run this script; figures land in `6_Results/Default_Parameters/1_ML_Default_Parameters/Visualizations/`.
...
if __name__ == "__main__":
    try:
        visualize_experiment_folder(
            ...
            experiment='1_ML_Default_Parameters',
        )
