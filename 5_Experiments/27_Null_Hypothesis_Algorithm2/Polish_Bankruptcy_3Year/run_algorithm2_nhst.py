...
--------------------------------
1. Load Experiment 3 matrices (data_L10.csv / data_L20.csv).
...
Results: 6_Results/27_Null_Hypothesis_Algorithm2/Polish_Bankruptcy_3Year/
"""
...
SOURCES = [
    os.path.abspath(f"{TDA_DIR}/data_L10.csv"),
    os.path.abspath(f"{TDA_DIR}/data_L20.csv"),
]
MAX_PER_GROUP = 100
N_PERM = 200
