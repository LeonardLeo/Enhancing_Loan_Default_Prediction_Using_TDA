...
```powershell
.\tda_env\Scripts\python.exe 5_Experiments/28_Revised_Snapshot_Protocol/run_protocol.py --stage all
.\tda_env\Scripts\python.exe 5_Experiments/28_Revised_Snapshot_Protocol/run_protocol.py --stage design
.\tda_env\Scripts\python.exe 5_Experiments/28_Revised_Snapshot_Protocol/run_protocol.py --stage split_ml --datasets credit_card_default
```
