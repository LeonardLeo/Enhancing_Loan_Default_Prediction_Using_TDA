# -*- coding: utf-8 -*-
"""
Revised snapshot protocol (Experiment 28).

Meeting decisions encoded here:
  - NO class balancing / undersampling — use full class pools.
...
def generate_fixed_t_snapshots(
    ...
    for class_name, frame in class_frames.items():
        ...
        class_dir = output_root / f"{class_name}_T{t}"
