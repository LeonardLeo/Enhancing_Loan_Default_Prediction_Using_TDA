...
```
5_Experiments/28_Revised_Snapshot_Protocol/Default_Of_Credit_Card_Client_Data/default_of_credit_card_client_protocol.py
5_Experiments/28_Revised_Snapshot_Protocol/Statlog_German_Credit_Data/statlog_german_credit_protocol.py
5_Experiments/28_Revised_Snapshot_Protocol/PKDD_Czech_Financial/pkdd_czech_financial_protocol.py
...
```
...
Numeric dump: `6_Results/28_Revised_Snapshot_Protocol/` (including `all_designs.json`).
...
```
python 5_Experiments/28_Revised_Snapshot_Protocol/Statlog_German_Credit_Data/statlog_german_credit_protocol.py
```
