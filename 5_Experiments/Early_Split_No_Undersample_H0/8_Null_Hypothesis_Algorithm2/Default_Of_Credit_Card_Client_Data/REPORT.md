# Default_Of_Credit_Card_Client_Data — Early_Split_No_Undersample_H0 / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_No_Undersample_H0/8_Null_Hypothesis_Algorithm2/Default_Of_Credit_Card_Client_Data/run.py
```
