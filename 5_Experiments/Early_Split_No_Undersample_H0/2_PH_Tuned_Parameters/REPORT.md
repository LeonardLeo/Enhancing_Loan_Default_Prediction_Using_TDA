# Early_Split_No_Undersample_H0 — 2_PH_Tuned_Parameters
...
CONSUMER. GridSearchCV on this process's H0-sliced experiment-1 barcode matrices. Does not regenerate Ripser.
...
6_Results/Early_Split_No_Undersample_H0/2_PH_Tuned_Parameters/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_No_Undersample_H0/2_PH_Tuned_Parameters/<Dataset>/<script>.py
```
