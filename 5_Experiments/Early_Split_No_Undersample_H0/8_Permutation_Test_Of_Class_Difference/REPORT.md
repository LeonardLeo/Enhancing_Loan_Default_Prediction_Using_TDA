# Early_Split_No_Undersample_H0 — 8_Permutation_Test_Of_Class_Difference
...
6_Results/Early_Split_No_Undersample_H0/8_Permutation_Test_Of_Class_Difference/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_No_Undersample_H0/8_Permutation_Test_Of_Class_Difference/<Dataset>/<script>.py
```
