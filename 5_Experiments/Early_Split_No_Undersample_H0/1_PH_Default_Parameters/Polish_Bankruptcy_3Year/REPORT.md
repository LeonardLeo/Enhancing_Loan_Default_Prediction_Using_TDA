# Polish_Bankruptcy_3Year — Early_Split_No_Undersample_H0 / 1_PH_Default_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_No_Undersample_H0/1_PH_Default_Parameters/Polish_Bankruptcy_3Year/run.py
```
