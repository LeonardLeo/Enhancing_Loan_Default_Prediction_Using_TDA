# Default_Of_Credit_Card_Client_Data — Early_Split_And_Undersample_H0_And_H1 / 8_Permutation_Test_Of_Class_Difference
...
CONSUMER. Robinson–Turner permutation test of class difference on this arm's barcode matrices.

Run:

```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_And_Undersample_H0_And_H1/8_Permutation_Test_Of_Class_Difference/Default_Of_Credit_Card_Client_Data/run.py
```
