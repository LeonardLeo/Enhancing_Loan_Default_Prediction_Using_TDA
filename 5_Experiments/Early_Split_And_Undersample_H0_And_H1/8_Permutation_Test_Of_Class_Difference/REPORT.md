# Early_Split_And_Undersample_H0_And_H1 — 8_Permutation_Test_Of_Class_Difference
...
6_Results/Early_Split_And_Undersample_H0_And_H1/8_Permutation_Test_Of_Class_Difference/{Dataset}/
```
...
Statlog TEST L30 observed F is almost the null mean. Do not quote “permutation test of class difference p = 0.005 everywhere.”
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_And_Undersample_H0_And_H1/8_Permutation_Test_Of_Class_Difference/<Dataset>/<script>.py
```
