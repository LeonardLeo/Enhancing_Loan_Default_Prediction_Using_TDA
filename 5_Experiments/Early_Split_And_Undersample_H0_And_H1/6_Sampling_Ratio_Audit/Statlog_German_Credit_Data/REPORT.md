# Statlog_German_Credit_Data — Early_Split_And_Undersample_H0_And_H1 / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_And_Undersample_H0_And_H1/6_Sampling_Ratio_Audit/Statlog_German_Credit_Data/run.py
```
