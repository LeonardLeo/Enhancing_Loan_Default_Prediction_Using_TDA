# Taiwan_Bankruptcy — Early_Split_And_Undersample_H0_And_H1 / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_And_Undersample_H0_And_H1/8_Null_Hypothesis_Algorithm2/Taiwan_Bankruptcy/run.py
```
