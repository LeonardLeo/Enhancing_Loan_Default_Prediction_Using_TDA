...
separately from the formula) live in:
    ...
    5_Experiments/{PROTOCOL_BUCKET}/9_Revised_Snapshot_Protocol/protocol_lib.py
    5_Experiments/{PROTOCOL_BUCKET}/9_Revised_Snapshot_Protocol/run_protocol.py
...
SCRIPT = Path(__file__).resolve().parents[3] / "run_protocol.py"
