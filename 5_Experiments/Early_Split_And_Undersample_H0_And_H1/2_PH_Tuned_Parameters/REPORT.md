# Early_Split_And_Undersample_H0_And_H1 — 2_PH_Tuned_Parameters
...
6_Results/Early_Split_And_Undersample_H0_And_H1/2_PH_Tuned_Parameters/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_And_Undersample_H0_And_H1/2_PH_Tuned_Parameters/<Dataset>/<script>.py
```
