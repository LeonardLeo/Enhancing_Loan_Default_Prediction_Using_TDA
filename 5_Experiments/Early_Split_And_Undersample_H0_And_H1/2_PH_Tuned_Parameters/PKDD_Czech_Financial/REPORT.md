# PKDD_Czech_Financial — Early_Split_And_Undersample_H0_And_H1 / 2_PH_Tuned_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_And_Undersample_H0_And_H1/2_PH_Tuned_Parameters/PKDD_Czech_Financial/run.py
```
