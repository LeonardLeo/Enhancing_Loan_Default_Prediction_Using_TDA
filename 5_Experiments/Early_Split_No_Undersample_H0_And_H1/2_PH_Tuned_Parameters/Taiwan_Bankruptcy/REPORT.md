# Taiwan_Bankruptcy — Early_Split_No_Undersample_H0_And_H1 / 2_PH_Tuned_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_No_Undersample_H0_And_H1/2_PH_Tuned_Parameters/Taiwan_Bankruptcy/run.py
```
