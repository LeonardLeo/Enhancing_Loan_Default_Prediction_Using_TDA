# -*- coding: utf-8 -*-
"""Visualize artefacts for Early_Split_No_Undersample_H0_And_H1 / 2_PH_Tuned_Parameters.

Runnable from this experiment directory:

    python visualize_results.py

Run this script; figures land in `6_Results/Early_Split_No_Undersample_H0_And_H1/2_PH_Tuned_Parameters/Visualizations/`.
