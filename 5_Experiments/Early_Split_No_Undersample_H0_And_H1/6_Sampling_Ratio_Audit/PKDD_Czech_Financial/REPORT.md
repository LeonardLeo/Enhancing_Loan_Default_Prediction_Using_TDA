# PKDD_Czech_Financial — Early_Split_No_Undersample_H0_And_H1 / 6_Sampling_Ratio_Audit
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_No_Undersample_H0_And_H1/6_Sampling_Ratio_Audit/PKDD_Czech_Financial/run.py
```
