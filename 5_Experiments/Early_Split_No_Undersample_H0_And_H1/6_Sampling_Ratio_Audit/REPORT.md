# Early_Split_No_Undersample_H0_And_H1 — 6_Sampling_Ratio_Audit
...
6_Results/Early_Split_No_Undersample_H0_And_H1/6_Sampling_Ratio_Audit/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_No_Undersample_H0_And_H1/6_Sampling_Ratio_Audit/<Dataset>/<script>.py
```
