# Statlog_German_Credit_Data — Early_Split_No_Undersample_H0_And_H1 / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_No_Undersample_H0_And_H1/8_Null_Hypothesis_Algorithm2/Statlog_German_Credit_Data/run.py
```
