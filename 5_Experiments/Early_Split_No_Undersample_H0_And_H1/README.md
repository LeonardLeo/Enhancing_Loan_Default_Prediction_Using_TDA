# Early split, no undersample, using both H0 and H1

Folder: `Early_Split_No_Undersample_H0_And_H1`

Public name (figures and paper tables): **Early split, no undersample, using both H0 and H1**. Names come from `utils.process_display_name()`.
...
The matching just-H0 process is `Early_Split_No_Undersample_H0/`. Nested extras live under `Archives/Four_Arm_Nested_Experiments/Early_Split_TDA_And_No_Undersampling/`.
