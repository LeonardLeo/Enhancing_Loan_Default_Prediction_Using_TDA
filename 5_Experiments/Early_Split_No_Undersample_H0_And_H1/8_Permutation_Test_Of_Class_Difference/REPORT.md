# Early_Split_No_Undersample_H0_And_H1 — 8_Permutation_Test_Of_Class_Difference
...
```
1_Data/Landmark_Sets/Early_Split_No_Undersample_H0_And_H1/1_PH_Default_Parameters/{Dataset}/
1_Data/Barcode_Statistics/Early_Split_No_Undersample_H0_And_H1/1_PH_Default_Parameters/{Dataset}/
1_Data/TDA_Datasets/Early_Split_No_Undersample_H0_And_H1/1_PH_Default_Parameters/{Dataset}/data_L*.csv
6_Results/Early_Split_No_Undersample_H0_And_H1/8_Permutation_Test_Of_Class_Difference/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Early_Split_No_Undersample_H0_And_H1/8_Permutation_Test_Of_Class_Difference/<Dataset>/<script>.py
```
