...
This figure holds the number of snapshots at utils.N_TRAIN_POOL. The x-axis is points per snapshot (every surviving candidate in utils.CANDIDATE_POINTS_PER_SNAPSHOT).
