...
This figure keeps every surviving (points per snapshot x number of snapshots) cell. The x-axis is the number of snapshots. One curve per cloud size.
...
ITEM = "4"
ITEM_FOLDER = "3_Snapshot_Count_Across_Cloud_Sizes"
PCA_N_COMPONENTS = 15
...
reduced = pd.DataFrame(
    ...
    columns=[f"PCA_{i}" for i in range(1, 15 + 1)],
