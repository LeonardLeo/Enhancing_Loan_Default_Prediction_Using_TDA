# Late_Split_No_Undersample_H0_And_H1 — 8_Permutation_Test_Of_Class_Difference
...
6_Results/Late_Split_No_Undersample_H0_And_H1/8_Permutation_Test_Of_Class_Difference/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_No_Undersample_H0_And_H1/8_Permutation_Test_Of_Class_Difference/<Dataset>/<script>.py
```
