# South_German_Credit — Late_Split_No_Undersample_H0_And_H1 / 8_Null_Hypothesis_Algorithm2
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_No_Undersample_H0_And_H1/8_Null_Hypothesis_Algorithm2/South_German_Credit/run.py
```
