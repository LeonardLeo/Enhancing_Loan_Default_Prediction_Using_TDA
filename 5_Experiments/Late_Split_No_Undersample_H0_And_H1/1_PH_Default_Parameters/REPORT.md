# Late_Split_No_Undersample_H0_And_H1 — 1_PH_Default_Parameters
...
6_Results/Late_Split_No_Undersample_H0_And_H1/1_PH_Default_Parameters/{Dataset}/
```
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_No_Undersample_H0_And_H1/1_PH_Default_Parameters/<Dataset>/<script>.py
```
