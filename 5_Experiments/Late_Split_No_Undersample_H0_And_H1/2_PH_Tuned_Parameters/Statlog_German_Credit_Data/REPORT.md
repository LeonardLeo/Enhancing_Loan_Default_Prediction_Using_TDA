# Statlog_German_Credit_Data — Late_Split_No_Undersample_H0_And_H1 / 2_PH_Tuned_Parameters
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_No_Undersample_H0_And_H1/2_PH_Tuned_Parameters/Statlog_German_Credit_Data/run.py
```
