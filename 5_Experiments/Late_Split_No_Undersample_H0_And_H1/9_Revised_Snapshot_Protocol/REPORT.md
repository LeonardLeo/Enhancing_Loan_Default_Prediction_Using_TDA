# Late_Split_No_Undersample_H0_And_H1 — Experiment 9 (revised snapshot protocol)

This is arm experiment 9 in **Late split, no undersample, using both H0 and H1** (late split, full class pools). The same engine exists in all four TDA arms. The meeting-driven write-up that originally used the label Experiment 28 lives at `docs/Revised_Snapshot_Protocol_Deep_Report.md`. There is no live top-level `28_Revised_…` folder.
...
```
5_Experiments/Late_Split_No_Undersample_H0_And_H1/9_Revised_Snapshot_Protocol/Default_Of_Credit_Card_Client_Data/default_of_credit_card_client_protocol.py
5_Experiments/Late_Split_No_Undersample_H0_And_H1/9_Revised_Snapshot_Protocol/Statlog_German_Credit_Data/statlog_german_credit_protocol.py
…
```
...
2. **split_ml** — apply this arm's split with no undersample; draw independent snapshots; fit models.
3. **full_ml** — Default of Credit Card Client extra arm that skips the customer split (documented in the launcher).

## Findings

Numeric dump: `6_Results/Late_Split_No_Undersample_H0_And_H1/9_Revised_Snapshot_Protocol/` (including `all_designs.json`). Figures: `6_Results/Late_Split_No_Undersample_H0_And_H1/9_Revised_Snapshot_Protocol/Visualizations/`.
...
```
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_No_Undersample_H0_And_H1/9_Revised_Snapshot_Protocol/run_protocol.py --stage all
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_No_Undersample_H0_And_H1/9_Revised_Snapshot_Protocol/run_protocol.py --stage design
.\tda_env\Scripts\python.exe 5_Experiments/Late_Split_No_Undersample_H0_And_H1/9_Revised_Snapshot_Protocol/Statlog_German_Credit_Data/statlog_german_credit_protocol.py
```
