...
`5_Experiments/26_Intrinsic_Dimension_Estimation/<Dataset>/run_intrinsic_dimension.py`
...
`6_Results/26_Intrinsic_Dimension_Estimation/{Folder}/intrinsic_dimension_estimates.csv`
