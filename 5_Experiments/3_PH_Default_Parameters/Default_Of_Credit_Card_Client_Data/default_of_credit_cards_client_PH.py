...
compute_barcodes_from_multiple_landmarks(landmark_percentages = percentages, # Should be same as used in GENERATE LANDMARK SETS function
                                         landmark_dir = "../../../1_Data/Landmark_Sets/Default_Of_Credit_Card_Client_Data/3_PH_Default_Parameters", 
                                         barcode_output_dir = "../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/3_PH_Default_Parameters", 
                                         dim = 2, 
                                         label = {1: "default",
                                                  0: "non-default"})
...
build_final_barcode_statistics_data(landmark_percentages = percentages,
                                    barcode_dir = "../../../1_Data/Barcode_Statistics/Default_Of_Credit_Card_Client_Data/3_PH_Default_Parameters",
                                    output_dir = "../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/3_PH_Default_Parameters",
                                    label = {1: "default",
                                             0: "non-default"})
...
# =============================================================================
paths = ["../../../1_Data/TDA_Datasets/Default_Of_Credit_Card_Client_Data/3_PH_Default_Parameters/data_L5.csv", 
