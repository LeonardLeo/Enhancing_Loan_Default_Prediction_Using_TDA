...
| `Snapshot_Sample_Size` | `2_Points_Per_Snapshot_Sweep` | `6_Results/Snapshot_Sample_Size/2_Points_Per_Snapshot_Sweep/Visualizations/` | Points per snapshot on the x-axis; always 180 snapshots. Combined overlay = mean trend (no error bars); companion panels hold 95% ribbons |
